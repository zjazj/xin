  ...
  <div class="mod-menu">
    <el-form :inline="true" :model="dataForm">
      <el-form-item style="margin-bottom:5px">
        <el-button size="mini" v-if="hasPermission('cms:cmsChannel:save')" type="primary" @click="addOrUpdateHandle()">新增</el-button>
      </el-form-item>
    </el-form>
    <el-table
      ...
      <el-table-column
        ...
        <template slot-scope="scope">
          ...
          <el-button v-if="hasPermission('cms:cmsChannel:delete')" size="mini" type="danger" @click="deleteHandle(scope.row.id)">删除</el-button>
        </template>
      </el-table-column>
    </el-table>
    ...
    methods: {
      ...
      deleteHandle (id, name) {
        this.$confirm('确定删除?', '提示', {
          ...
          this.Api.cmsChannelDelete(id).then(result => {
